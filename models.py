...
# ── Seed data (moved out for lighter model context) ──────────────────────────
from seed_data import seed_org as _seed_org_data, seed_projects as _seed_projects_data


def seed_org() -> dict:
    return _seed_org_data(ALL_SKILLS)


def seed_projects() -> list:
    return _seed_projects_data()
