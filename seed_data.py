"""
TeamIQ – seed / demo data.
Kept separate from models.py to avoid token bloat on that file.
"""
from models import ALL_SKILLS
...
def seed_org(all_skills=None) -> dict:
    """Return the default demo organisation tree."""
    return {
