...
let ganttBarResizeDrag = null;   // right-edge drag
let ganttBarStartDrag  = null;   // left-edge drag (moves start date)
let ganttBarMoveDrag   = null;   // whole-bar drag (moves start+end)
let ganttBarResizeSetup = false;
let ganttStartMs = 0;            // project epoch ms, set by renderTimeline
